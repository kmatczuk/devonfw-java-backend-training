package com.devonfw.app.java.order.general.common.api.constants;
...
public abstract class PermissionConstants {
  ...
  /** {@link AccessControlPermission Permission} to raise a price of item. */
  public static final String RAISE_PRICE = "RaisePrice";
}